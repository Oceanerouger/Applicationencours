                ...
                <div class="col-12 multislider_at2">
                        ...
                        <div class="col-md-1 hautparleur"><svg class="speaker" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 13.32 8.57">
                                ...
                                <g id="Calque_2" data-name="Calque 2">
                                    <g id="Calque_1-2" data-name="Calque 1">
                                        ...
                                        <path class="cls-100" d="M12.64.19c-.05,0-.14,0-.18.06-.87.62-1.74,1.25-2.62,1.86-.05.05-.16,0-.25,0s.05-.16.12-.21L12.31.07c.1-.07.19-.15.33.12" />
                                        <path class="cls-100" d="M13.32,3.32c-.08.06-.11.13-.21.13-.51,0-1,0-1.54,0v.09H10a.3.3,0,0,1-.16,0,.11.11,0,0,1-.09-.07.18.18,0,0,1,.09-.14.3.3,0,0,1,.16,0c1,0,2,0,3.07,0a.42.42,0,0,1,.21.09" />
                                        <path class="cls-100" d="M12.05,6.76a.61.61,0,0,1-.19,0,1.48,1.48,0,0,1-.27-.19c-.66-.57-1.35-1.12-2-1.67a.19.19,0,0,1-.13-.1s0-.08,0-.14a.25.25,0,0,1,.16,0,3.1,3.1,0,0,1,.34.27c.65.54,1.33,1.08,2,1.61l.16.18a.24.24,0,0,0,0,.07" />
                                    </g>
                                </g>
                            </svg> </div>
                        <form action="curseurconnect.php" method="post">

                            <input type="range" min="0" max="100" class="slider" step="25" id="myRange1" name="curseura" onclick="getValue1()">
                        </form>
                        <div class="col-md-1 drapeau"><svg class="drap" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15.06 8.51">
                                ...
                                <g id="Calque_2" data-name="Calque 2">
                                    <g id="Calque_1-2" data-name="Calque 1">
                                        ...
                                        <path class="cls-100" d="M134.51,339.71v-1c-.4-.31-1-.67-.4-1.41l.76.55,0,0c0,.26-.11.5-.16.81.24.08.5.15.79.23,0,.22-.08.44-.13.67h.78c0,.86,0,.86-1.07,1,.05-.27.1-.51.13-.82h-.68Z" transform="translate(-124.77 -335.43)" />
                                        <path class="cls-100" d="M134.51,339.69c-.16.23-.29.44-.48.7-.68-.24-.84-.7-.42-1.37l.9.69Z" transform="translate(-124.77 -335.43)" />
                                        ...
                                        <path class="cls-100" d="M129.84,337.8c.26-.17.47-.32.73-.52.29.48.37.87-.16,1.25-.13.11-.13.39-.15.61a1.73,1.73,0,0,0,0,.56h-.76c.05.29.13.52.16.73-.82.24-1.08-.23-1.24-.87v0h1a7.78,7.78,0,0,0-.23-.76l0,0,.89-.19c-.05-.32-.07-.58-.13-.86Z" transform="translate(-124.77 -335.43)" />
                                        <path class="cls-100" d="M130.23,339.69c.26-.23.55-.42.84-.65.39.87.39.95-.45,1.34-.13-.25-.26-.47-.39-.7Z" transform="translate(-124.77 -335.43)" />
                                        <path class="cls-100" d="M136.71,337.87c.31-.09.6-.19,1-.28,0,.86-.39,1-1.05.9.05-.23.08-.42.11-.65Z" transform="translate(-124.77 -335.43)" />
                                        <path class="cls-100" d="M138.41,338.6c-.1.27-.15.52-.23.8-.26,0-.55-.1-.82-.17,0-.78.4-.86,1-.63" transform="translate(-124.77 -335.43)" />
                                        <path class="cls-100" d="M129.86,337.78c.06.28.08.54.13.86l-.89.19c0-.25,0-.51-.08-.81.27-.06.55-.16.84-.24" transform="translate(-124.77 -335.43)" />
                                        <path class="cls-100" d="M129.13,338.81a8,8,0,0,1,.23.77h-1c0-.28-.07-.56-.13-.92l.87.15" transform="translate(-124.77 -335.43)" />
                                        <path class="cls-100" d="M128,337.86a3.19,3.19,0,0,1,.08.63c-.65.15-1.05-.07-1.05-.9l1,.28Z" transform="translate(-124.77 -335.43)" />
                                        <path class="cls-100" d="M127.34,339.23c-.26.07-.47.11-.78.17a5.94,5.94,0,0,1-.26-.78c.6-.22,1-.19,1,.61" transform="translate(-124.77 -335.43)" />
                                    </g>
                                </g>
                            </svg></div>
                    </div>
                    ...
                    <div class="container-fluid slidecontainer">
                        ...
                        <form action="curseurconnect.php" method="post">
                            ...
                            <input type="range" min="0" max="100" class="slider" step="25" id="myRange2" name="curseurc" onclick="getValue2()">
                        </form>
                        <div class="col-md-1 drapeau"><svg class="drap" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15.06 8.51">
                                <defs>
                                    <style>
                    ...
                    <div class="container-fluid slidecontainer">
                        ...
                        <form action="curseurconnect.php" method="post">
                            ...
                            <input type="range" min="0" max="100" class="slider" step="25" id="myRange3" name="curseurd" onclick="getValue3()">
                        </form>
                        <div class="col-md-1 drapeau"><svg class="drap" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15.06 8.51">
                                <defs>
                                    <style>
                    ...
                    <div class="container-fluid slidecontainer">
                        ...
                        <form action="curseurconnect.php" method="post">
                            ...
                            <input type="range" min="0" max="100" class="slider" step="25" id="myRange4" name="curseure" onclick="getValue4()">
                        </form>
                        <div class="col-md-1 drapeau"><svg class="drap" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 15.06 8.51">
                                <defs>
                                    <style>
                                ...
                                <svg class="button_next_at2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 4.75 4.75">
                                    ...
                                    <g id="Calque_2" data-name="Calque 2">
                                        <g id="Calque_1-2" data-name="Calque 1">
                                            ...
                                            <path class="cls-3" d="M2.6,1.65l.79.74-.79.74-.17-.22.41-.37s0,0-.06,0H1.36v-.3H2.81L2.4,1.88Z" />
                                        </g>
                                    </g>
                                </svg></button>
                </a>
